...
file_path = '/home/tengmo/crawler_to_server/store/' + sys.argv[1]
dict_site = eval(open('/home/tengmo/crawler_to_server/output/'+ sys.argv[1]+  '_dict_site.txt').read())
...
with open('/home/tengmo/crawler_to_server/output/json/' + sys.argv[1] + '_json_dict'+'.json', 'w') as outfile:
